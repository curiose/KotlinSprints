...
//
//Запиши в переменные соответствующие значения, явно указывая их тип. Для всех переменных выбирай тип данных, занимающий наименьшее возможное место в памяти,
